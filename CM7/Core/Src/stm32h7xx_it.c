...
//char buf2[50];
//
////__attribute__((section(".TxBuffer"), used)) uint8_t TxBuf[10];
//
//int indx = 1;
//
//__attribute__((section(".TxBuffer"), used)) uint32_t TxBuf[12]; //Source buffer.
//
//
//
//
//
//
//__attribute__((section(".RxBuffer"), used)) union rxbuf{ // Destination buffer used as union.
//	float Rx2Buf[12];
//
//	uint32_t RxBuf[12];
//
